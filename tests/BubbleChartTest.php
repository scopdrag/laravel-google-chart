...
class BubbleChartTest extends TestCase {
    ...
    public function testExample() {
        ...
        $chartManager = ChartManager::setChartType('bubble-chart')
                ->setOptions($options)
                ->setCols($cols)
                ->setRows($rows);
        ...
        $this->assertEquals('bubble-chart', $chartManager->getChartType());
        $this->assertRegExp('/visualization\\.BubbleChart/', $content);
    }
